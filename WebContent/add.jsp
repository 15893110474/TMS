			...
			<div class="box">
				<div class="search">
					...
					<div class="box_center">
						<form action="newSS" method="post" enctype="multipart/form-data">
							<span>&nbsp;</span>
							<div class="add">
								<div class="add_center" >
									<div class="add_main center">
										...
										<div class="username">所在城市：<input class="shurukuang" type="text" id="city" name="city" size="20" placeholder="限制10字" maxlength="10"></div>
										<div class="username">消费 / 元：<input class="shurukuang" type="text" id="consumption" name="consumption" size="20" oninput = "value=value.replace(/[^\d]/g,'')" maxlength="4" placeholder="请输入景区日均大概消费"></div>
										<div class="username">详细地址：<input class="shurukuang" type="text" id="address" name="address" size="20" placeholder="限制30字" maxlength="30"></div>
										<div class="username">景区特点：<textarea class="" id="introduce"  name="introduce" placeholder="请简单介绍一下该景区"></textarea></div>
										<div class="username">景区介绍：<textarea class="" id="characteristic" name="characteristic" placeholder="请简单介绍该景区的特色"></textarea></div>
										<div class="username">风景图一：<input class="image" type="file" id="imgUrl" name="imgUrl" onchange="preview(this)"><span id="preview"><img class="updateImg" style="display: none;" id="imgHidden" /></span></div>
										<div class="username">风景图二：<input class="image" type="file" id="imgUrl2" name="imgUrl2" onchange="preview2(this)"><span id="preview2"><img class="updateImg" style="display: none;" id="imgHidden2" /></span></div>
