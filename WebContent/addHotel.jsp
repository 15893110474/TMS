...
<body>
	<div class="main">
		...
		<div class="info">
			<div class="box">
				<div class="search">
					<div class="box_top"><b class="pl15" style="font-family: 楷体">添加新宾馆</b></div>
					<div class="box_center">
						<form action="newSH" method="post" enctype="multipart/form-data">
							<span>&nbsp;</span>
							<div class="add">
								<div class="add_center" >
									<div class="add_main center">
										...
										<%} %>
										<div class="username">宾馆名称：<input class="shurukuang" type="text" name="name" size="20" placeholder="限制15字" maxlength="15"></div>
										<div class="username">宾馆类型：<input class="shurukuang" type="text" name="type" size="20" placeholder="—— ——选择宾馆类型—— ——"list="types"/><datalist id="types"><option>五星级</option><option>六星级</option><option>七星级</option></datalist></div>
										<div class="username">价格 / 元：<input class="shurukuang" type="text" name="price" size="20" oninput = "value=value.replace(/[^\d]/g,'')" maxlength="4" placeholder="请输入宾馆当前类型的价格"></div>
										<div class="username">详细地址：<input class="shurukuang" type="text" name="address" size="20" placeholder="限制30字" maxlength="30"></div>
										<div class="username">宾馆介绍：<textarea class=""  name="introduce" placeholder="请简单介绍该宾馆"></textarea></div>
										<div class="username">宾馆图片：<input class="image" type="file" name="imgUrl" onchange="preview(this)"><span id="preview"><img class="updateImg" style="display: none;" id="imgHidden" /></span></div>
									</div>
