	...
	<div class = "main">
		...
		<div class="article-content" style="color: black;">
			<p style="text-align: center;">
				<span >饭馆名称：</span><span class="bjh-p"><a href="https://hotel.bestwehotel.com/" target="_blank">${restaurant.name }</a></span><br><br>
				<span >平均消费：</span><span class="bjh-p">${restaurant.consumption }元</span><br><br>
				<span >详细地址：</span><span class="bjh-p">${restaurant.address }</span><br><br>
				<span class="bjh-p"></span>
			</p>
			
			<div class="img-container">
				<img class="large" src="./img/${restaurant.imgUrl }">
			</div>
			<p><span class="bjh-p">${restaurant.introduce }</span></p>
		</div>
		</div>
	</div>
</body>
